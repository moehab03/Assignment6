...
public class HomeScreenActivity extends AppCompatActivity {
    ...
    ArrayList<Integer> coursesPictureArray = new ArrayList<>();
    ArrayList<String> coursesNameArray = new ArrayList<>();
    ArrayList<String> coursesDetailsArray = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fillCoursesNameArrayList();
        fillCoursesPicArrayList();
        fillDetailsArrayList();

        recyclerView = findViewById(R.id.recyclerView);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

        adapter = new CoursesAdapter(this, coursesPictureArray, coursesNameArray, coursesDetailsArray);
        recyclerView.setAdapter(adapter);

    }

    private void fillCoursesPicArrayList() {
        coursesPictureArray.add(R.drawable.android);
        coursesPictureArray.add(R.drawable.ios);
        coursesPictureArray.add(R.drawable.full_stack);

    }

    private void fillCoursesNameArrayList() {
        coursesNameArray.add("Android Course");
        coursesNameArray.add("IOS Course");
        coursesNameArray.add("Full Stack");
    }

    public void fillDetailsArrayList() {

        coursesDetailsArray.add("Part 1 ( Java SE)\n" +
        ...
        coursesDetailsArray.add("OOP refreshment\n" +
                "• Introduction\n" +
